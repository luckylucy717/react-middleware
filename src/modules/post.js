...
export const getPost = (postId) => dispatch => {
    ...
    return getPostAPI(postId).then((response)=>{
        // 요청이 성공했다면 서버 응답 내용을 payload로 설정하여 GET_POST_SUCCESS에 디스패치합니다.
        ...
        // GET_POST_FAILURE 액션에 디스패치합니다.
        dispatch(getPostFailure(error))
        // error를 throw하여 이 함수를 실행한 후 
        // 다시한번 catch 할 수 있게 합ㄴ디ㅏ.
        throw(error)
    })
}
export const getPost2 = (postId) =>({
    type: GET_POST, 
    payload: getPost2(postId)
})
